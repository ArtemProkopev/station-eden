...
export declare const ClientRegisterSchema: z.ZodEffects<z.ZodObject<{
    email: z.ZodString;
    username: z.ZodString;
    password: z.ZodString;
} & {
...
export type WebSocketMessageType = 'JOIN_LOBBY' | 'PLAYER_JOINED' | 'PLAYER_LEFT' | 'CHAT_MESSAGE' | 'SEND_MESSAGE' | 'LOBBY_STATE' | 'PLAYER_READY' | 'TOGGLE_READY' | 'UPDATE_LOBBY_SETTINGS' | 'LOBBY_SETTINGS_UPDATED' | 'START_GAME' | 'GAME_STARTED' | 'GAME_STATE' | 'GAME_UPDATE' | 'PLAYER_LEFT_GAME' | 'GAME_ACTION' | 'ERROR';
...
export type Notification = NewsNotification | GameInviteNotification | SystemNotification | FriendRequestNotification;
