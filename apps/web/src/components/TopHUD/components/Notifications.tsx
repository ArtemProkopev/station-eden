  ...
  return (
    ...
    >
      <button
        ...
        aria-haspopup="menu"
        aria-label={hasNotifications ? `Уведомления (${unreadCount} непрочитанных)` : 'Уведомления'}
        title="Уведомления"
      >
            ...
            {hasNotifications ? (
              notifications.map((notification) => (
                ...
                >
                  ...
                  {notification.type === 'game_invite' && (
                    <div className={styles.inviteActions}>
                      <button
                        ...
                        onClick={() => handleAcceptInvite(notification.id, notification.lobbyId)}
                      >
                        Принять
                      </button>
                      <button
                  ...
                  {notification.type === 'friend_request' && (
                    <div className={styles.friendActions}>
                      ...
                      <button
                        type="button"
                        className={styles.declineButton}
                        onClick={() => onNotificationAction?.(notification.id, 'decline')}
                      >
                        Отклонить
                      </button>
                    </div>
                  ...
                  {notification.type === 'news' && 'link' in notification && notification.link && (
                    <button
                      type="button"
              ...
              <div className={styles.emptyState}>
                ...
                <p className={styles.emptySubtext}>Здесь появятся ваши уведомления</p>
              </div>
            )}
          </div>
