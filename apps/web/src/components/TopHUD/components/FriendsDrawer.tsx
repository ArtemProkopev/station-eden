...
const FriendItem = React.memo(function FriendItem({
  ...
  const handleAction = React.useCallback((action: string, e: React.MouseEvent) => {
    e.stopPropagation()
    setShowMenu(false)
  ...
  const handleChatClick = React.useCallback((e: React.MouseEvent) => {
    e.stopPropagation()
    onStartChat(friend.id)
    ...
    >
      <div className={styles.friendMain}>
        <div className={styles.friendAvatar}>
          ...
          <span className={`${styles.statusIndicator} ${styles[friend.status]}`} />
        </div>
        ...
        <div className={styles.friendInfo}>
          ...
          <span className={styles.friendStatus}>
            ...
            {isActiveChat && <span className={styles.activeChatBadge}> ● в чате</span>}
          </span>
        </div>
