...
const FALLBACKS: Record<IconType, React.ReactNode> = {
	rocket: (
		<svg viewBox='0 0 24 24' width='34' height='34' aria-hidden='true'>
			...
			<path
				fill='#63EFFF'
				d='M12 2s4 1 6 3 3 6 3 6-3 0-6-2-6-6-6-6z'
				opacity='0.95'
			/>
		</svg>
	),
	avatar: (
		<svg viewBox='0 0 24 24' width='40' height='40' aria-hidden='true'>
			...
			<path
				fill='#204C72'
				d='M12 14c-3 0-6 1.5-6 4.5v1h12v-1c0-3-3-4.5-6-4.5z'
			/>
		</svg>
	),
	star: (
		<svg viewBox='0 0 24 24' width='18' height='18' aria-hidden='true'>
			...
			<path
				fill='#63EFFF'
				d='M12 17.3 6.6 20l1.2-6.9L2 9.3l6.9-1L12 2l3.1 6.3 6.9 1-5.8 3.8L17.4 20z'
			/>
		</svg>
	),
}
