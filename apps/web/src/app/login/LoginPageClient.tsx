...
import { EyeIcon, EyeOffIcon, ClockIcon } from '@/src/components/ui/Icons'
...
export default function LoginPageClient() {
  ...
  const handleSuccessfulLogin = useCallback((userData: UserData) => {
  ...
  const renderReasonMessage = useMemo(() => {
    ...
    const messages = {
      google_exists: 'Аккаунт с этим Google-email уже существует — просто войдите.',
      google_no_account: 'Похоже, такого аккаунта ещё нет. Вы можете зарегистрироваться.'
    }
