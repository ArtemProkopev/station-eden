...
export default function PlayersList({
  ...
  const handleAddPlayerClick = () => {
    console.log('Add player button clicked - opening modal');
    onAddPlayer();
  };
    ...
    <div className={styles.playersBlock}>
      ...
      <div className={styles.playersListContainer}>
        <div className={styles.playersList}>
          {players.map((player) => (
            <div key={player.id} className={`${styles.playerCard} ${player.isReady ? styles.ready : ''}`}>
              <div className={styles.playerInfo}>
                ...
                {player.isReady && <span className={styles.readyBadge}>Готов</span>}
              </div>
              <button 
      ...
      <div className={styles.playerActions}>
        <button
          ...
          title={players.length >= maxPlayers ? `Достигнут лимит игроков (${maxPlayers})` : "Добавить игрока"}
        >
          добавить игрока
        ...
        <button
          ...
          title={!currentUserId ? "Профиль не загружен" : "Переключить готовность"}
        >
