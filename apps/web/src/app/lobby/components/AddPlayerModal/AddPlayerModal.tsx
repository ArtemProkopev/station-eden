// components/AddPlayerModal/AddPlayerModal.tsx
'use client';
...
interface AddPlayerModalProps {
  onClose: () => void;
  onAddPlayer: (playerData?: { id?: string; name?: string; avatar?: string }) => void;
}

export function AddPlayerModal({ onClose, onAddPlayer }: AddPlayerModalProps) {
  ...
  const handleAddFriend = (friend: typeof friends[0]) => {
    onAddPlayer(friend);
  };
