...
export const PlanetIcon = ({ className, onError }: IconProps) => (
  <svg 
    viewBox='0 0 24 24' 
    width='34' 
    height='34' 
...
export const PolygonIcon = ({ className, onError }: IconProps) => (
  <svg 
    viewBox='0 0 24 24' 
    width='34' 
    height='34' 
...
export const FallbackIcon = ({ 
  ...
  const IconComponent = type === 'planet' ? PlanetIcon : PolygonIcon;
